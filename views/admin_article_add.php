...
ob_start()
?>
<form enctype="multipart/form-data" id="formProduitAdd" method="POST">
    <div class="form-group">
        <label for="idnom">Nom</label>
        <input type="text" placeholder="Pas de caracères spéciaux autorisés" class="form-control" id="idnom" name="nom">
    </div>
    <div class="form-group">
